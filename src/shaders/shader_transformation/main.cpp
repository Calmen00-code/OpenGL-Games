...
int main()
{
    ...
    std::string vertShaderSrc = loadShaderSrc("assets/shader_vertex_core_transformation.glsl");
    ...
    std::string fragShaderSrc = loadShaderSrc("assets/shader_fragment_core_transformation.glsl");
    ...
    fragShaderSrc = loadShaderSrc("assets/shader_fragment_core2_transformation.glsl");
