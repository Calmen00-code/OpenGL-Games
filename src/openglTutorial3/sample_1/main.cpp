...
//	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // uncomment this statement for OS X
	...
	// ------------------------------------
	Shader ourShader("assets/sample1_vertex_core.glsl", "assets/sample1_fragment_core.glsl");
	...
	register_texture(&tex_sky,"assets/textures/night_sky.jpg");
	register_texture(&tex_red_dark,"assets/textures/red_dark.jpg");
	register_texture(&tex_red_bright,"assets/textures/red_bright.jpg");
	register_texture(&tex_red,"assets/textures/red.jpg");
	register_texture(&tex_green,"assets/textures/green.jpg");
	register_texture(&tex_blue,"assets/textures/blue.jpg");
